...
from config import ID_PICK, TOKEN
...
@dp.callback_query_handler(text='daily_payment_plan')
...
@dp.callback_query_handler(text='finished', state='*')
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_the_number_of_touts)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_inf_on_boats_cruises)
...
# 'list_with_general_overloads_for_boats' not in current_state_date:        

@dp.message_handler(state=StepsToCalculatePayment.waiting_for_inf_on_overloads_cruises)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_the_amount_of_cash_for_cruises)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_the_amount_of_non_cash_for_cruises)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_the_amount_of_cash_for_bar)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_the_amount_of_non_cash_for_bar)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_how_much_was_paid_in_cash)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_how_much_was_paid_in_non_cash)
...
@dp.message_handler(state=StepsToCalculatePayment.waiting_for_the_amount_of_non_cash_for_souvenirs)
...
@dp.message_handler(commands=['shift'])
